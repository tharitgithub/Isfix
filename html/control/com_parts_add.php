...
<div class="card card-primary">
  <div class="card-header">
    <h3 class="card-title"><i class="fas fa-laptop mr-1"></i>เพิ่มอะไหล่คอมพิวเตอร์</h3>
  </div>
  <!-- /.card-header -->
  <!-- form start -->
  <form id="com_parts_add-form" autocomplete="off">
    <div class="card-body">
      <div class="row">
...
<script src="js/com_parts_add.js"></script>
